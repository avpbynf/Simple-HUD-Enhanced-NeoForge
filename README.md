...
This repository is a fork of the original Fabric mod, adapted to run on the [NeoForge](https://neoforged.net/) mod loader for Minecraft 26.2+. All credit for the mod itself — its features, design and assets — goes to SoRadGaming and the upstream contributors. Only the loader-specific plumbing (build system, mod metadata, event hooks) differs from upstream.
...
2. Download and install [NeoForge](https://neoforged.net/) for Minecraft 26.2.
